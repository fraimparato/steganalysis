...
\begin{document}
    ...
    In particular we will focus on some of the most common methods the steganalytic techniques involved to detect and in some cases
    even retrieve the embedded information.
    Notice that since different cover types requires different approaches
